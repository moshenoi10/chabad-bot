...
כללים מחייבים:
- כותרת ראשית: רגש + עובדה + שם מרכזי, עם נקודתיים (:). לפחות 8 מילים. חייב להתבסס רק על מה שכתוב בטקסט.
- כותרת משנה: פרטים מופרדים ב-•. לפחות 15 מילים. רק מידע שמופיע בטקסט.
- כותרת אדומה: 2-4 מילים עוצמתיות מתוך הטקסט.
- גוף הכתבה: העתק את הטקסט המקורי בדיוק מילה במילה. אסור להוסיף, לשנות או להמציא אפילו מילה אחת. חלק לפסקאות של 2-4 משפטים. הסר * _ ~ אבל שמור גרשיים.
- אם הטקסט קצר – הגוף יהיה קצר. אין להרחיב.
- תגיות: 5-8 מילות מפתח מתוך הטקסט בלבד.
- שמור על גרשיים עבריים: חב״ד, ל״ג, אדמו״ר (גרש עברי ״ ולא ")
