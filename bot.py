...
def _wa_help():
    msg = (
        "👋 *ברוך הבא לבוט " + SITE_NAME + "!*\n\n"
        "הבוט מאפשר להעלות כתבות, תמונות ומזל טוב ישירות מוואטסאפ.\n\n"
        "━━━━━━━━━━━━━━━\n"
        "📤 *העלאת כתבה חדשה*\n"
        "━━━━━━━━━━━━━━━\n"
        "1️⃣ שלח // לפתיחה\n"
        ...
        "━━━━━━━━━━━━━━━\n"
        "1️⃣ שלח /ערוך\n"
        "2️⃣ שלח את לינק הכתבה\n"
        "3️⃣ ערוך: /כותרת /משנה /אדומה /גוף /תמונה /מדיה\n"
        "4️⃣ שלח /סיום לשמירה\n\n"
        "━━━━━━━━━━━━━━━\n"
        "🎉 *מזל טוב*\n"
        "━━━━━━━━━━━━━━━\n"
        ...
        "📊 *כלים נוספים*\n"
        "━━━━━━━━━━━━━━━\n"
        "//סטטוס – כמה כתבות פורסמו היום\n"
        "/מובילות – 5 הכתבות הנצפות השבוע\n"
        "/אפס – אפס הכל ותתחיל מחדש\n"
        "//עזרה – הצג הודעה זו\n\n"
        "━━━━━━━━━━━━━━━\n"
        "💡 *טיפים*\n"
        "━━━━━━━━━━━━━━━\n"
...
def send_whatsapp(message, image_url=None, to=None):
    ...
    instance_id = os.environ.get("GREENAPI_ID", "")
    token = os.environ.get("GREENAPI_TOKEN", "")
    group_id = to or os.environ.get("WHATSAPP_PUBLISH_GROUP_ID") or os.environ.get("WHATSAPP_GROUP_ID", "")
